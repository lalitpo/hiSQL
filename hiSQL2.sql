...
-- JSON defines a textual data interchange format which is easy for humans to write and machines
-- to parse

-- JSON Documentation : http://json.org/

-- SQL:2016 defines SQL↔JSON interoperability. JSON values may be constructed/traversed and 
